...
global {
	...
	date starting_date <- date("2022-10-11 11:00:00"); 
	...
	int numVehiclesPackageTraditional <- 35 min:30 max:40 parameter: "Number or Vehicles for Package Delivery in Traditional Scenario" category:"Initial";
	
	//----------------------Autonomous Scenario-------------------------
	//-----------------Autonomous Bike Parameters-----------------------
	int numAutonomousBikes <- 150 min: 50 max: 300 parameter: "Num Autonomous Bikes:" category: "Bike";
	float maxBatteryLifeAutonomousBike <- 50000.0 #m	min: 35000#m max: 65000#m step: 15000 parameter: "Autonomous Bike Battery Capacity (m):" category: "Bike"; //battery capacity in m
	float PickUpSpeedAutonomousBike <-  11/3.6 #m/#s min: 8/3.6 #m/#s max: 14/3.6 #m/#s step: 3/3.6 parameter: "Autonomous Bike Pick-up Speed (m/s):" category:  "Bike";
	...
	string rechargeRate <- "111s" parameter: "Full Refuel/Recharge" category: "Bike" among: ["4.5hours", "111s"];
	bool nightRechargeCond <- true parameter: "Night Recharge Condition" category: "Bike";
	bool rechargeCond <- true parameter: "Battery Condition" category: "Bike";
	
	//----------------------Traditional Scenario-------------------------
	//------------------------Car Parameters------------------------------
	// Data extracted from: https://www.thecoldwire.com/how-many-miles-does-a-full-tank-of-gas-last/
	int numCars <- 0 min:30 max:45 parameter: "Num Cars:" category: "Car";
	//float maxFuelCar <- 342000.0 #m	min: 320000.0#m max: 645000.0#m parameter: "Car Battery Capacity (m):" category: "Car";
	float maxFuelCar <- 342000.0 #m	min: 320000.0#m max: 645000.0#m;
